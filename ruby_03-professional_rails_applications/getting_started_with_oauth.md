...
Next time teaching this lesson, let's update the lesson plan to include using `Omniauth.mock_auth` for testing. There has been a good amount of confusion and time lost with students related to a lack of understanding on the subject.
